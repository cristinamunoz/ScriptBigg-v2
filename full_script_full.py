...
def read_dict(dict_bigg, dict_metanetx, metacyc_dict, pwynames_dict):
    ...
    for key, value in dict_bigg.iteritems():
        ...
        if rxn_metacyc is None:
            print key, value, rxn_metacyc
        else:
            for i in rxn_metacyc:
                pwy_rxn = metacyc_dict.get(i)
                
                print key, value, i, AddPwyName(pwy_rxn, pwynames_dict)
...
def main():
    ...
    read_dict(dict_bigg, dict_metanetx, metacyc_dict, pwynames_dict)
